            ...
            <div class="card" style="max-width: 60%; margin: 10px auto">
                <div class="card-body">
                    ...
                    <form class="form-group" action="{{ route('specialist-visa.store') }}" method="POST"
                        ...
                        <label for="resume" class="mb-2 mt-3"><b>@lang('form.resume_activity')</b></label>
                        ...
                        <label for="file2" class="mb-2 mt-3"><b>@lang('form.income_last')</b></label>
                        ...
                        <label for="file3" class="mb-2 mt-3"><b>@lang('form.income_plan')</b></label>
