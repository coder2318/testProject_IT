    ...
    <section class="d-flex align-items-center justify-content-center " style="background-color: lightgray">
        <div class="container mt-5">
            <div class="card" style="max-width: 60%; margin: 10px auto">
                <div class="card-body">
                    <div class="" style="text-align: center; font-size: 24px; font-weight: bold">@lang('form.investor')
                    </div>
                    <form class="form-group" action="{{ route('investor.store') }}" method="POST"
                        ...
                        <label for="activity" class="mb-2 mt-3"><b>@lang('form.activity_investor')</b></label>
                        <span style="color: #b02a37; font-weight: bold">* {{ $errors->first('activity') }}</span>
                        <textarea id="activity" class="form-control p-2 ps-3" type="text" style="border-radius: 10px"
                            name="activity" value="{{ old('activity') }}"></textarea>

                        <div>
                            <label for="file" class="mb-2 mt-3"><b>@lang('form.bank_shyot')</b></label>
                        ...
                        <div>
                            <label for="file2" class="mb-2 mt-3"><b>@lang('form.copy')</b></label>
                        ...
                        <div>
                            <label for="file3" class="mb-2 mt-3"><b>@lang('form.application_investor')</b></label>
                        ...
                        <div>
                            ...
                            @endif
                                    target="_blank">@lang('form.terms_conditions')</a></label><span style="color: #b02a37; font-weight: bold">*
                            {{ $errors->first('conditions') }}</span><input style="margin-left:5px" id="checkbox" type="checkbox" name="conditions">
                        </div>
